 ...
 */
olympus_extractMakernotes = function (data, makernoteOffset, tiffOffset) {
    ...
    var isBigEndian = false // this.isBigEndian
	...
	for (var i = 0; i < numberOfEntries; i++) {
		var exifEntry = this.extractExifEntry(data, (ifdOffset + 2 + (i * 12)), tiffOffset, false, tags);
